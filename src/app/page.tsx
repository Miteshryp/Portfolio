...
export default function Home() {
	return (
		<main className="homeBackground">
			<Navbar />
			<div className="px-2 lg:px-10 w-full h-full flex flex-col items-start justify-start gap-2 lg:gap-64">
				{/* Center Section */}
				<section
					className={`
            mt-40
          ...
          `}
					>
						...
						{/* <Heading>{"Hii, I'm Mitesh"}</Heading> */}
          ...
          `}
						>
							<div
								onClick={() => {
									saveAs(
										"https://drive.google.com/file/d/1-N5uhLaUzhZK0_T70K8CyMs-bzdAYCvZ/view?usp=drive_link",
